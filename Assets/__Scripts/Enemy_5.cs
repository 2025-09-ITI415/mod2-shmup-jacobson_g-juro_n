...
[Header("Enemy_5 Inscribed Fields")]
    ...
    /// <summary>
    /// Enemy_5 Collisions are handled differently from other Enemy subclasses
    ...
    void OnCollisionEnter( Collision coll )
    {
         ...
         if ( p != null )
         {
             ...
             {
                 // Find the GameObject of this Enemy_5 that was actually hit
                 ...
                 // Destroy this Enemy_5
                 Destroy( gameObject );
            }
            else
            {
                Debug.Log( "Enemy_5 hit by non-ProjectileHero: " + otherGO.name );
            }
        }
    }
